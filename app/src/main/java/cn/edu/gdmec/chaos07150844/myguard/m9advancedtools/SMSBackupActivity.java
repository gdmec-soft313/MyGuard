...
import cn.edu.gdmec.chaos07150844.myguard.m9advancedtools.utils.SmsBackUpUtils;
import cn.edu.gdmec.chaos07150844.myguard.m9advancedtools.utils.UIUtils;
import cn.edu.gdmec.chaos07150844.myguard.m9advancedtools.widget.MyCircleProgress;
                        ...
                        try{
                            ...
                            public void beforeSmsBackup(int size){
                                if (size<=0){
                                    flag=false;
                                    smsBackUpUtils.setFlag(flag);
                                    UIUtils.showToast(SMSBackupActivity.this,"你没有短信");
                            ...
                            e.printStackTrace();
                            UIUtils.showToast(SMSBackupActivity.this,"SD卡可用或SD卡内存不足");
                        }catch (IOException e){
                            e.printStackTrace();
